...
class Mod_media_link extends MY_Model {

  var $table_name = 'media_link';
  var $_table_name = 'media_link';
  var $id_field = 'ml_id';
  var $entry_field = 'ml_entry';
  var $stamp_field = 'ml_stamp';
  var $status_field = 'ml_status';
  var $order_by = 'ml_entry';
  var $order_dir = 'DESC';
