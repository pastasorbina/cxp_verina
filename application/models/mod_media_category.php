...
class Mod_media_category extends MY_Model {

  var $table_name = 'media_category';
  var $_table_name = 'media_category';
  var $id_field = 'mc_id';
  var $entry_field = 'mc_entry';
  var $stamp_field = 'mc_stamp';
  var $status_field = 'mc_status';
  var $order_by = 'mc_entry';
  var $order_dir = 'DESC';
