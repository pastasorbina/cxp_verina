...
*/
	...
	//define('CRON_CI_INDEX', $_SERVER['PWD']."/../index.php");   // Your CodeIgniter main index.php file
	define('CRON_CI_INDEX', "/var/www/gudangbrands.com/index.php");   // Your CodeIgniter main index.php file

	//define('CRON_CI_INDEX', '/var/www/metrop.co.jp/index.php');
    define('CRON', TRUE);   // Test for this in your controllers if you only want them accessible via cron

	// Rickyok patch
	$_SERVER['HTTP_HOST'] = '127.0.0.1';
	$_SERVER['REMOTE_ADDR'] = '127.0.0.1';
	$_SERVER['HTTP_USER_AGENT'] = 'Ravintola Cron';
	$_SERVER['SERVER_ADMIN'] = 'webmaster@localhost';
	$_SERVER['SERVER_ADDRESS'] = 'localhost';
